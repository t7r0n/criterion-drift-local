...
- Local CLI and JSONL tool loop for `criterion-drift`.
...
This is a local prototype, not a production healthcare-intake integration. A production version would need authentication, tenant isolation, rate limits, formal privacy review, logging policy, and validation against private ground truth.
